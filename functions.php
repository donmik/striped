<?php
/**
 * stripedbydonmik functions and definitions
 *
...
if ( ! function_exists( 'striped_by_donmik_setup' ) ) :
/**
 ...
 */
function striped_by_donmik_setup() {
...
endif; // striped_by_donmik_setup
add_action( 'after_setup_theme', 'striped_by_donmik_setup' );
...
add_action( 'widgets_init', 'striped_by_donmik_widgets_init' );
...
function striped_by_donmik_options($name, $default=false) {
    $options = ( get_option( 'striped_by_donmik_options' ) ) ? get_option( 'striped_by_donmik_options' ) : null;
    // return the option if it exists
    if ( isset( $options[ $name ] ) ) {
        return apply_filters( 'striped_by_donmik_options_$name', $options[ $name ] );
    }
    // return default if nothing else
    return apply_filters( 'striped_by_donmik_options_$name', $default );
}
